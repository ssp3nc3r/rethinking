...
ggplot(dsim) + theme_tufte(base_family = 'sans') +
...
ggplot(nd) + theme_tufte(base_family = 'sans') +
...
p1 <- ggplot(nd) + theme_tufte(base_family = 'sans') +
  geom_ribbon(aes(x = 1:4, 
                  ymin = p_mu_hpdi_l,
                  ymax = p_mu_hpdi_h),
              alpha = .1) +
...
p2 <- ggplot(nd) + theme_tufte(base_family = 'sans') +
  geom_ribbon(aes(x = 1:4, 
                  ymin = sim_mu_hpdi_l,
                  ymax = sim_mu_hpdi_h),
              alpha = .1) +
