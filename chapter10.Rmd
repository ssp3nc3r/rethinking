...
# f_sim_10_10 <- function(P, C) with(post10_10, 
#                             rpois(1e3, a + bp * P + bc * C + bpc * C * P) )
# sim_10_10 <- mapply(f_sim_10_10, P = nd$log_pop, C = nd$contact_high)
...
# f_sim_10_11 <- function(P, C) with(post10_11, 
#                             rpois(1e3, a + bp * P + bc * C) )
# sim_10_11 <- mapply(f_sim_10_11, P = nd$log_pop, C = nd$contact_high)
...
# f_sim_10_12 <- function(P) with(post10_12, 
#                             rpois(1e3, a + bp * P) )
# sim_10_12 <- mapply(f_sim_10_12, P = nd$log_pop)
...
# sim_ensemble <- weights[1] * (sim_10_10) + weights[2] * (sim_10_11) + weights[3] * (sim_10_12)
# sim_ensemble_mean <- colMeans(sim_ensemble)
# sim_ensemble_hpdi <- apply(sim_ensemble, 2, rethinking::HPDI)

nd <- nd %>%
  mutate(mu = mu_ensemble_mean,
         mu_hpdi_l = mu_ens_hpdi[1,],
         mu_hpdi_h = mu_ens_hpdi[2,],
         # sim_hpdi_l = sim_ensemble_hpdi[1,],
         # sim_hpdi_h = sim_ensemble_hpdi[2,],
